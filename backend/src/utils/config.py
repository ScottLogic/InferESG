...
class Config(object):
    def __init__(self):
        ...
        self.esg_report_agent_model = None
    ...
    def load_env(self):
        ...
        try:
            ...
            self.esg_agent_llm = os.getenv("ESG_REPORT_AGENT_LLM")
            ...
            self.esg_report_agent_model = os.getenv("ESG_REPORT_AGENT_MODEL")
