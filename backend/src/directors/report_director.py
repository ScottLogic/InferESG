...
from src.session.file_uploads import FileUpload, ReportResponse, store_report, update_session_file_upload_with_company, update_session_file_uploads
...
async def create_report_from_file(upload: UploadFile) -> ReportResponse:
    ...
    file = LLMFile(id=file_id, file_name=upload.filename, file=file_stream)
